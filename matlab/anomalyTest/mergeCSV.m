...
for i=1:length(clients)
    client=clients(i);
    if client<10
        dataAll=dlmread(sprintf('client-0%d_03070200.csv', client),',',1,0);
    elseif client>=10
        dataAll=dlmread(sprintf('client-%d_03070200.csv', client),',',1,0);
    end
...
save('QoE2007', 'responseTime', 'TS', 'QoE1','QoE2');